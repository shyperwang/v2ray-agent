...
#    echoContent yellow "添加伪装博客--->"
    ...
    rm -rf /www/wwwroot/proxy/html
    wget -q -P /www/wwwroot/proxy/html https://raw.githubusercontent.com/mack-a/v2ray-agent/${branch}/fodder/blog/unable/html.zip > /dev/null
    unzip -o  /www/wwwroot/proxy/html.zip -d /www/wwwroot/proxy/html > /dev/null
...
unInstall(){
    ...
    rm -rf /www/server/panel/vhost/nginx/alone.conf
    rm -rf /usr/bin/vasma
